...
//         // ⭐ Backend Requirement Notification ⭐
//         // 1. GET /pending-assignments:
//         //    Create an endpoint on your backend that fetches all submitted assignments
//         //    with 'status: "pending"'.
//         //    This endpoint should also accept a 'userEmail' query parameter (or get it from auth token)
//         //    to EXCLUDE submissions where 'submitterEmail' matches 'userEmail'.
//         //    Example: /api/pending-assignments?graderEmail=currentUser@example.com
...
//         // ⭐ Backend Requirement Notification ⭐
//         // 2. PUT /submitted-assignments/:id/grade:
//         //    Create an endpoint on your backend to update a specific submitted assignment.
//         //    This endpoint should:
//         //    - Receive the updated marks, feedback, status, and gradedBy.
//         //    - Verify that the grader is NOT the submitter (crucial backend validation).
//         //    - Update the corresponding fields in MongoDB.
...
//                 </div>
//             ) : (
//                 <div className="overflow-x-auto rounded-lg shadow-xl border border-base-300 dark:border-gray-700">
