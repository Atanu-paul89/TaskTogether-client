...
// import { Link, useNavigate } from 'react-router'; // Ensure Link is from 'react-router-dom' and add useNavigate
// console.log(motion);
// const MySubmission = () => {
...
//     const [myPostedAssignments, setMyPostedAssignments] = useState([]); // New state for posted assignments
//     const [loading, setLoading] = useState(true);
//     const [error, setError] = useState(null);
//     const [viewMode, setViewMode] = useState('submitted'); // 'submitted' or 'posted'
...
//         setError(null);
//         try {
//             // ⭐ NEW FETCH URL for posted assignments ⭐
...
//         }
//     }, [user?.email, viewMode]); // Re-run effect when user email or viewMode changes
...
//         // Add SweetAlert confirmation here similar to Assignments.jsx/AssignmentDetails.jsx
//         // For brevity, direct delete for now, but confirmation is highly recommended
//         if (!user || !user.email) {
...
//                                             animate={{ opacity: 1, y: 0 }}
//                                             transition={{ duration: 0.4, delay: 0.1 * mySubmittedAssignments.indexOf(submission) }}
//                                             className="card bg-base-100 shadow-xl border border-base-300 dark:border-700 p-4"
//                                         >
//                                             <div className="mb-2">
...
//                         ) : (
//                             <>
//                                 {/* Table for larger devices (sm and up) for Posted Assignments */}
//                                 <div className="overflow-x-auto rounded-lg shadow-xl border border-base-300 dark:border-gray-700 hidden sm:block">
//                                     <table className="table w-full text-base-content">
//                                         <thead>
//                                             <tr className="bg-base-200 text-lg">
...
//                                 {/* Card-like display for smaller devices (below sm) for Posted Assignments */}
//                                 <div className="sm:hidden grid grid-cols-1 gap-4">
//                                     {myPostedAssignments.map((assignment) => (
//                                         <motion.div
//                                             key={assignment._id}
...
// new code // 
// src/components/MyWork.jsx (assuming you have renamed it as instructed previously)
import React, { useContext, useEffect, useState } from 'react';
import { AuthContext } from '../FireBase/AuthContext';
