...
//     // Handle user logout with SweetAlert2 confirmation
//     const handleLogout = () => {
//         Swal.fire({
//             title: 'Are you sure?',
...
//                         </>
//                     )}
//                     {/* New "More" dropdown for desktop */}
//                     <li>
//                         <details>
//                             <summary className={navLinkClasses}>More</summary> {/* Apply navLinkClasses to summary for consistent styling */}
//                             <ul className="p-2 bg-base-100 rounded-t-none">
//                                 <li><NavLink to="/about" className={navLinkClasses}>About Us</NavLink></li>
//                                 <li><NavLink to="/contact" className={navLinkClasses}>Contact</NavLink></li>
//                                 <li><NavLink to="/jobs" className={navLinkClasses}>Jobs</NavLink></li>
...
//                             </li>
//                             <li><NavLink to="/update-profile" className={navLinkClasses}>Update Profile</NavLink></li>
//                             {/* Call handleLogout for SweetAlert2 confirmation */}
//                             <li><button onClick={handleLogout}>Logout</button></li>
//                         </ul>
//                     </div>
//                 ) : (
...
const Navbar = () => {
    ...
    return (
        // Add `fixed top-0 w-full z-50` for fixed navbar position and high z-index
